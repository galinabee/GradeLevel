...
//   t.end();
// });
++cov_259l78nd1p.s[3];test("two_parts",t=>{++cov_259l78nd1p.f[0];const musicXML=(++cov_259l78nd1p.s[4],fs.readFileSync("./scores/rhythmic_complexity.xml"));const toscanini=(++cov_259l78nd1p.s[5],Toscanini(musicXML));{const actual=(++cov_259l78nd1p.s[6],toscanini.getRhythmComplexity());const expected=(++cov_259l78nd1p.s[7],["half 1","quarter 0","quarter 1","eighth 0","whole 0","half 0","quarter 3"]);++cov_259l78nd1p.s[8];t.deepEqual(actual,expected,"getRhythmComplexity score");}++cov_259l78nd1p.s[9];t.end();});// test("two_parts", (t) =>
// {
